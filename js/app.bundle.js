...
module.exports = __webpack_require__(77)|| !__webpack_require__(9)(function(){
  var K = Math.random();
...
var _buffers = __webpack_require__(161);

var _scheduler = __webpack_require__(422);
...
var _sagaHelpers = __webpack_require__(421);
...
var _channel = __webpack_require__(162);
...
var reducers_1 = __webpack_require__(453);
exports.reducer = reducers_1.default;
var actions_1 = __webpack_require__(452);
exports.actions = actions_1.default;
var initial_1 = __webpack_require__(259);
...
var react_redux_1 = __webpack_require__(124);
var redux_1 = __webpack_require__(126);
var Tabs_1 = __webpack_require__(267);
var typesFormsFields_1 = __webpack_require__(276);
var MultipleAnswerCard_1 = __webpack_require__(454);
var SingleAnswerCard_1 = __webpack_require__(455);
var redux_2 = __webpack_require__(260);
function mapStateToProps(state) {
    var initialFormData = state.polls.initialFormData;
...
var Polls = function (_React$Component) {
    (0, _inherits3.default)(Polls, _React$Component);

    function Polls() {
        (0, _classCallCheck3.default)(this, Polls);
        return (0, _possibleConstructorReturn3.default)(this, (Polls.__proto__ || (0, _getPrototypeOf2.default)(Polls)).apply(this, arguments));
    }

    (0, _createClass3.default)(Polls, [{
        key: "render",
        value: function render() {
            var b = block('polls');
            var initialFormData = this.props.initialFormData;

            return React.createElement(Tabs_1.Tabs, { activeKey: initialFormData.typeForm }, React.createElement(Tabs_1.Tab, { eventKey: typesFormsFields_1.typesForms.sa1 }, React.createElement(SingleAnswerCard_1.default, { initialData: initialFormData })), React.createElement(Tabs_1.Tab, { eventKey: typesFormsFields_1.typesForms.ma1 }, React.createElement(MultipleAnswerCard_1.default, { initialData: initialFormData })));
        }
    }]);
    return Polls;
}(React.Component);
...
var react_redux_1 = __webpack_require__(124);
var configureStore_1 = __webpack_require__(448);
...
var ReactApp = function () {
    function ReactApp() {
        ...
        var api = new Api_1.default('/api');

        var _configureStore_1$def = configureStore_1.default(api),
            store = _configureStore_1$def.store,
            runSaga = _configureStore_1$def.runSaga;

        this.store = store;
        this.rootComponent = React.createElement(react_redux_1.Provider, { store: store }, React.createElement(App_1.App, null));
    }
    ...
    (0, _createClass3.default)(ReactApp, [{
        ...
        key: "passFormDataInStore",
        value: function passFormDataInStore(jsonParseConfig) {
...
var redux_saga_1 = __webpack_require__(937);
var polls_1 = __webpack_require__(449);
function configureStore(api) {
    var sagaMiddleware = redux_saga_1.default();
    var extraArguments = { api: api };
    var middlewares = [sagaMiddleware, redux_thunk_1.default.withExtraArgument(extraArguments)];
    var reducer = redux_1.combineReducers({
        polls: polls_1.reducer
    });
    var store = redux_1.createStore(reducer, redux_1.compose(redux_1.applyMiddleware.apply(redux_1, middlewares),  false ? window.devToolsExtension() : function (arg) {
        return arg;
    }));
    return {
        store: store,
...
function changeFormField(fieldName, fieldValue) {
    return { type: 'POLLS:CHANGE_FORM_FIELD', payload: { fieldName: fieldName, fieldValue: fieldValue } };
}
...
var communication_1 = __webpack_require__(451);
var actions = {
...
var initial_1 = __webpack_require__(259);
var immutable_1 = __webpack_require__(252);
function reducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initial_1.default;
    var _ref = arguments[1];
    var type = _ref.type,
        payload = _ref.payload;

    var imState = immutable_1.fromJS(state);
    switch (type) {
        ...
        case 'POLLS:CHANGE_FORM_FIELD':
            {
                ...
                return imState.setIn(['formData', [fieldName]], fieldValue).toJS();
            }
        default:
            return state;
    }
...
var React = __webpack_require__(0);
var block = __webpack_require__(22);
var components_1 = __webpack_require__(168);
var elements_1 = __webpack_require__(111);
__webpack_require__(693);

var MultipleAnswerCard = function (_React$Component) {
    (0, _inherits3.default)(MultipleAnswerCard, _React$Component);

    function MultipleAnswerCard() {
        (0, _classCallCheck3.default)(this, MultipleAnswerCard);

        var _this = (0, _possibleConstructorReturn3.default)(this, (MultipleAnswerCard.__proto__ || (0, _getPrototypeOf2.default)(MultipleAnswerCard)).apply(this, arguments));

        _this.b = block('multiple-answer-card');
        return _this;
    }

    (0, _createClass3.default)(MultipleAnswerCard, [{
        key: "render",
        value: function render() {
            var b = this.b;
            var initialData = this.props.initialData;

            return React.createElement(components_1.Card, { initialData: initialData }, React.createElement(elements_1.CheckboxGroup, { checkboxInputs: initialData.checkboxInputs }));
        }
    }]);
...
var SingleAnswerCard = function (_React$Component) {
    (0, _inherits3.default)(SingleAnswerCard, _React$Component);

    function SingleAnswerCard() {
        (0, _classCallCheck3.default)(this, SingleAnswerCard);

        var _this = (0, _possibleConstructorReturn3.default)(this, (SingleAnswerCard.__proto__ || (0, _getPrototypeOf2.default)(SingleAnswerCard)).apply(this, arguments));

        _this.b = block('single-answer-card');
        return _this;
    }

    (0, _createClass3.default)(SingleAnswerCard, [{
        key: "render",
        value: function render() {
            var b = this.b;
            var initialData = this.props.initialData;

            return React.createElement(components_1.Card, { initialData: initialData }, React.createElement(elements_1.RadioGroup, { radioInputs: initialData.radioInputs }));
        }
    }]);
...
var App_1 = __webpack_require__(457);
...
function mapStateToProps(state) {
    var _state$polls$initialF = state.polls.initialFormData,
        logo = _state$polls$initialF.logo,
        progress = _state$polls$initialF.progress;
...
var App = function (_React$Component) {
    ...
    (0, _createClass3.default)(App, [{
        key: "render",
        value: function render() {
            var b = block('application');
            var _props = this.props,
                logo = _props.logo,
                progress = _props.progress;

            return React.createElement("div", { className: b() }, React.createElement("div", { className: b('body') }, React.createElement(Header_1.default, { logo: logo, progress: progress }), React.createElement(Polls_1.default, null), React.createElement(Footer_1.default, null)));
        }
    }]);
    return App;
}(React.Component);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(33)(proto, TO_PRIMITIVE, __webpack_require__(526));
...
$export($export.S + $export.F * !__webpack_require__(16), 'Object', {defineProperties: __webpack_require__(306)});
...
var LIBRARY            = __webpack_require__(77)
  ...
  , microtask          = __webpack_require__(199)()
  , PROMISE            = 'Promise'
  , TypeError          = global.TypeError
  , process            = global.process
  , $Promise           = global[PROMISE]
...
__webpack_require__(16) && $export($export.P + __webpack_require__(140), 'Object', {
...
__webpack_require__(195)($RegExpStringIterator, 'RegExp String', function next(){
...
var _runSaga = __webpack_require__(939);
...
var _middleware = __webpack_require__(938);

var _middleware2 = _interopRequireDefault(_middleware);

var _effects = __webpack_require__(936);

var effects = _interopRequireWildcard(_effects);

var _utils2 = __webpack_require__(940);
...
var _proc = __webpack_require__(248);
...
var DomParser_1 = __webpack_require__(250);
var createReactApp_1 = __webpack_require__(426);
var injectTapEventPlugin = __webpack_require__(164);
__webpack_require__(427);
injectTapEventPlugin();
document.addEventListener('DOMContentLoaded', function () {
    var parser = new DomParser_1.DomParser();
    var htmlParseData = parser.parseFormData();
    var app = new createReactApp_1.default();
    var question = htmlParseData && htmlParseData.hiddenInputs.find(function (item) {
        return item.name === 'I.SavePoint';
    });
