...
var Checkbox_1 = __webpack_require__(269);
exports.Checkbox = Checkbox_1.default;
var CheckboxGroup_1 = __webpack_require__(270);
exports.CheckboxGroup = CheckboxGroup_1.default;
var FormControl_1 = __webpack_require__(272);
exports.FormControl = FormControl_1.default;
var Input_1 = __webpack_require__(169);
exports.Input = Input_1.default;
var InputsList_1 = __webpack_require__(273);
...
var RadioBtn_1 = __webpack_require__(171);
exports.RadioBtn = RadioBtn_1.default;
var RadioGroup_1 = __webpack_require__(274);
exports.RadioGroup = RadioGroup_1.default;
var ErrorsList_1 = __webpack_require__(271);
exports.ErrorsList = ErrorsList_1.default;
...
var Footer = function (_React$Component) {
    ...
    (0, _createClass3.default)(Footer, [{
        ...
        value: function render() {
            var b = this.b;
            return React.createElement("div", { className: b() }, React.createElement("div", { className: b('description') }, "\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F Ipsos \u043D\u0435 \u0438\u043C\u0435\u0435\u0442 \u043D\u0438\u043A\u0430\u043A\u043E\u0433\u043E \u043E\u0442\u043D\u043E\u0448\u0435\u043D\u0438\u044F \u043A \u044D\u0442\u043E\u043C\u0443 \u043A\u043E\u043D\u0442\u0435\u043D\u0442\u0443"), React.createElement("div", { className: b('copyright') }, "Copyright, 2017"));
        }
    }]);
    return Footer;
}(React.Component);
...
var Header = function (_React$Component) {
    ...
    function Header() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (Header.__proto__ || (0, _getPrototypeOf2.default)(Header)).apply(this, arguments));
    ...
    (0, _createClass3.default)(Header, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: b() }, React.createElement("div", { className: b('logo-img') }, React.createElement("img", { src: logo })), React.createElement("div", { className: b('progress-bar') }, React.createElement(ProgressBar_1.default, { value: progress })), React.createElement("div", { style: { clear: 'both' } }));
        }
    }]);
    return Header;
}(React.Component);
...
var Card_1 = __webpack_require__(264);
exports.Card = Card_1.default;
var Footer_1 = __webpack_require__(166);
exports.Footer = Footer_1.default;
var Header_1 = __webpack_require__(167);
...
var React = __webpack_require__(0);
var block = __webpack_require__(22);
var decko_1 = __webpack_require__(145);
...
__decorate([decko_1.bind], Input.prototype, "changeInput", null);
Object.defineProperty(exports, "__esModule", { value: true });
...
var React = __webpack_require__(0);
var block = __webpack_require__(22);
var progressTheme = __webpack_require__(703);
var progress_bar_1 = __webpack_require__(243);
...
var ProgressBar = function (_React$Component) {
    ...
    function ProgressBar() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (ProgressBar.__proto__ || (0, _getPrototypeOf2.default)(ProgressBar)).apply(this, arguments));

        _this.b = block('progress-bar');
        return _this;
    }
    ...
    (0, _createClass3.default)(ProgressBar, [{
        ...
        value: function render() {
            ...
            var b = this.b;
            return React.createElement("div", { className: b() }, React.createElement("span", { className: b('title') }, value + "%"), React.createElement(progress_bar_1.ProgressBar, { theme: progressTheme, type: "linear", mode: "determinate", buffer: value }));
        }
    }]);
    return ProgressBar;
}(React.Component);
...
var React = __webpack_require__(0);
var block = __webpack_require__(22);
var radio_1 = __webpack_require__(244);
var style_styl_1 = __webpack_require__(704);

var RadioBtn = function (_React$Component) {
    (0, _inherits3.default)(RadioBtn, _React$Component);

    function RadioBtn() {
        (0, _classCallCheck3.default)(this, RadioBtn);

        var _this = (0, _possibleConstructorReturn3.default)(this, (RadioBtn.__proto__ || (0, _getPrototypeOf2.default)(RadioBtn)).apply(this, arguments));

        _this.b = block('radio-button');
        return _this;
    }

    (0, _createClass3.default)(RadioBtn, [{
        key: "render",
        value: function render() {
            var b = this.b;
            var _props = this.props,
            ...
            return React.createElement("div", { className: b({ active: checked }) }, React.createElement(radio_1.RadioButton, { theme: style_styl_1.default, name: name, disabled: disabled, label: label, checked: checked, value: value, onChange: onChange }));
        }
    }]);
    return RadioBtn;
}(React.Component);
...
var _setPrototypeOf = __webpack_require__(465);
...
var typesFormsFields_1 = __webpack_require__(276);
var $ = __webpack_require__(762);

var DomParser = function () {
    function DomParser() {
        (0, _classCallCheck3.default)(this, DomParser);
    ...
    (0, _createClass3.default)(DomParser, [{
        key: "parseFormData",
        value: function parseFormData() {
            var typeForm = $(typesFormsFields_1.typesFields.typeForm).val();
        ...
        key: "parseSA1Form",
        value: function parseSA1Form() {
            var _this = this;

            var $questionTable = $(typesFormsFields_1.typesFields.questionTable);
            $questionTable.children().each(function (index, element) {
                var $radioElm = $(element).find(typesFormsFields_1.typesFields.radioElement)[0];
                var $radioTitle = $(element).find(typesFormsFields_1.typesFields.radioTitle);
                _this.jsonParseData.radioInputs.push({
                    text: $radioTitle.text(),
                    name: $radioElm.name,
                    type: $radioElm.type,
                    value: $radioElm.value,
                    checked: $radioElm.checked
                });
            });
        ...
        key: "parseMA1Form",
        value: function parseMA1Form() {
            var _this2 = this;

            var $questionTable = $(typesFormsFields_1.typesFields.questionTable);
            $questionTable.children().each(function (index, element) {
                var $checkboxElm = $(element).find(typesFormsFields_1.typesFields.checkboxElement)[0];
                var $checkboxTitle = $(element).find(typesFormsFields_1.typesFields.checkboxTitle);
                _this2.jsonParseData.checkboxInputs.push({
                    text: $checkboxTitle.text(),
                    name: $checkboxElm.name,
                    type: $checkboxElm.type,
                    value: $checkboxElm.value,
                    checked: $checkboxElm.checked
                });
            });
            return this.jsonParseData;
        }
        ...
        key: "setCommonFields",
        value: function setCommonFields() {
            var _this3 = this;

            var $header = $(typesFormsFields_1.typesFields.header);
            var $form = $(typesFormsFields_1.typesFields.form);
            var $bannerText = $(typesFormsFields_1.typesFields.bannerText);
            var $questionText = $(typesFormsFields_1.typesFields.questionText);
            var $progress = $(typesFormsFields_1.typesFields.progress);
            var $nextButton = $(typesFormsFields_1.typesFields.nextButton);
            var $prevButton = $(typesFormsFields_1.typesFields.prevButton);
            var $errors = $(typesFormsFields_1.typesFields.error);
            ...
            this.jsonParseData.errors.push({ text: $errors.text() });
            $form.children().each(function (index, element) {
                if (element.tagName === 'INPUT') {
                    _this3.jsonParseData.hiddenInputs.push({
...
var testContext = __webpack_require__(951);
...
var HttpActions_1 = __webpack_require__(263);
var decko_1 = __webpack_require__(145);
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return this.actions.get('/categories/');
...
__decorate([decko_1.bind], Api.prototype, "loadCategories", null);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = Api;
...
var HttpActions = function () {
    function HttpActions(baseURL) {
        (0, _classCallCheck3.default)(this, HttpActions);
    ...
    (0, _createClass3.default)(HttpActions, [{
        key: "get",
        value: function get(url, params, options) {
            var config = __assign({ params: params }, options);
        ...
        key: "del",
        value: function del(url, data, params, options) {
            var config = __assign({ url: url, data: data, params: params }, options);
            return this.request.delete(url, config);
        }
    }, {
        key: "put",
        value: function put(url, data, params, options) {
            return this.request.put(url, data, __assign({ params: params }, options));
        }
    }]);
    return HttpActions;
}();
...
var React = __webpack_require__(0);
var block = __webpack_require__(22);
var elements_1 = __webpack_require__(111);
...
var Card = function (_React$Component) {
    ...
    function Card() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (Card.__proto__ || (0, _getPrototypeOf2.default)(Card)).apply(this, arguments));
    ...
    (0, _createClass3.default)(Card, [{
        ...
        value: function render() {
            ...
            return React.createElement("form", { className: b(), action: initialData.form.action, method: initialData.form.method }, React.createElement(elements_1.InputsList, { list: initialData.hiddenInputs }), React.createElement("div", { className: b('content') }, React.createElement("div", { className: b('text') }, initialData.questionText), React.createElement(elements_1.ErrorsList, { errors: initialData.errors }), React.createElement("div", { className: b('options') }, React.createElement(elements_1.FormControl, null, children)), React.createElement("div", { className: b('button-control') }, React.createElement(elements_1.Button, { label: "Назад", theme: "back", name: initialData.buttons[0].name, value: initialData.buttons[0].value, type: "submit" }), React.createElement(elements_1.Button, { label: "Далее", theme: "next", name: initialData.buttons[1].name, value: initialData.buttons[1].value, type: "submit" }))));
        }
    }]);
    return Card;
}(React.Component);
...
var Tab = function (_React$Component) {
    ...
    (0, _createClass3.default)(Tab, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", null, activeKey && activeKey.includes(eventKey.substr(0, 2)) ? children : null);
        }
    }]);
    return Tab;
}(React.Component);
    ...
    (0, _createClass3.default)(Tabs, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", null, React.Children.map(children, function (child) {
                return React.cloneElement(child, { activeKey: activeKey });
            }));
        }
    }]);
    return Tabs;
...
var Tabs_1 = __webpack_require__(266);
exports.Tabs = Tabs_1.default;
var Tab_1 = __webpack_require__(265);
...
var styles = __webpack_require__(698);
...
var style_styl_1 = __webpack_require__(699);
var Checkbox = function Checkbox(props) {
    ...
    var b = block('checkbox-button');
    return React.createElement("div", { className: b({ active: checked }) }, React.createElement(checkbox_1.Checkbox, { theme: style_styl_1.default, name: name, value: value, label: label, checked: checked, disabled: disabled, onChange: onChange }));
};
Object.defineProperty(exports, "__esModule", { value: true });
...
var _defineProperty2 = __webpack_require__(469);
...
var _defineProperty4 = __webpack_require__(90);
...
var __decorate = undefined && undefined.__decorate || function (decorators, target, key, desc) {
    ...
    if ((typeof Reflect === "undefined" ? "undefined" : (0, _typeof3.default)(Reflect)) === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);else for (var i = decorators.length - 1; i >= 0; i--) {
        if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    }return c > 3 && r && (0, _defineProperty5.default)(target, key, r), r;
};
var React = __webpack_require__(0);
var block = __webpack_require__(22);
var elements_1 = __webpack_require__(111);
...
var CheckboxGroup = function (_React$Component) {
    ...
    (0, _createClass3.default)(CheckboxGroup, [{
        ...
        value: function render() {
            ...
            var b = this.b;
            var checkboxInputs = this.props.checkboxInputs;

            return React.createElement("div", { className: b() }, checkboxInputs.map(function (input, index) {
                return React.createElement(elements_1.Checkbox, { key: index, checked: _this2.state[input.name], onChange: _this2.handleChange.bind(_this2, input.name), label: input.text, name: input.name, value: input.value });
            }));
        }
    }, {
        key: "handleChange",
...
__decorate([decko_1.bind], CheckboxGroup.prototype, "handleChange", null);
Object.defineProperty(exports, "__esModule", { value: true });
...
var ErrorsList = function (_React$Component) {
    (0, _inherits3.default)(ErrorsList, _React$Component);

    function ErrorsList() {
        (0, _classCallCheck3.default)(this, ErrorsList);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ErrorsList.__proto__ || (0, _getPrototypeOf2.default)(ErrorsList)).apply(this, arguments));

        _this.b = block('errors-list');
        return _this;
    }

    (0, _createClass3.default)(ErrorsList, [{
        key: "render",
        value: function render() {
            var b = this.b;
            var errors = this.props.errors;

            return React.createElement("div", { className: b() }, errors.map(function (error) {
                return React.createElement("div", { className: b('error') }, error.text);
            }));
        }
    }]);
    return ErrorsList;
...
var FormControl = function (_React$Component) {
    ...
    function FormControl() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (FormControl.__proto__ || (0, _getPrototypeOf2.default)(FormControl)).apply(this, arguments));

        _this.b = block('form-control');
        return _this;
    }
...
var InputsList = function (_React$Component) {
    (0, _inherits3.default)(InputsList, _React$Component);

    function InputsList() {
        (0, _classCallCheck3.default)(this, InputsList);

        var _this = (0, _possibleConstructorReturn3.default)(this, (InputsList.__proto__ || (0, _getPrototypeOf2.default)(InputsList)).apply(this, arguments));

        _this.b = block('inputs-list');
        return _this;
    }

    (0, _createClass3.default)(InputsList, [{
        key: "render",
        value: function render() {
            var b = this.b;
            var list = this.props.list;

            return React.createElement("div", { className: b() }, list.map(function (input) {
...
var RadioGroup = function (_React$Component) {
    ...
    (0, _createClass3.default)(RadioGroup, [{
        ...
        value: function render() {
            ...
            var b = this.b;
            var radioInputs = this.props.radioInputs;

            return React.createElement("div", { className: b() }, radioInputs.map(function (input, index) {
                return React.createElement(RadioBtn_1.default, { key: index, label: input.text, name: input.name, checked: _this2.state.value === input.value || input.checked, value: input.value, onChange: _this2.handleChange });
            }));
        }
    }, {
        key: "handleChange",
...
__decorate([decko_1.bind], RadioGroup.prototype, "handleChange", null);
Object.defineProperty(exports, "__esModule", { value: true });
...
module.exports = !__webpack_require__(64) && !__webpack_require__(92)(function(){
...
__webpack_require__(290);
__webpack_require__(291);
module.exports = __webpack_require__(185).f('iterator');
...
var global    = __webpack_require__(38)
  ...
  , isNode    = __webpack_require__(112)(process) == 'process';
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(113)(Function.call, __webpack_require__(177).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var anObject  = __webpack_require__(63)
  , aFunction = __webpack_require__(172)
  , SPECIES   = __webpack_require__(31)('species');
...
$export($export.S + $export.F * !__webpack_require__(64), 'Object', {defineProperty: __webpack_require__(66).f});
...
var toIObject                 = __webpack_require__(67)
  , $getOwnPropertyDescriptor = __webpack_require__(177).f;

__webpack_require__(285)('getOwnPropertyDescriptor', function(){
...
var LIBRARY            = __webpack_require__(128)
  ...
  , isObject           = __webpack_require__(93)
  , aFunction          = __webpack_require__(172)
  , anInstance         = __webpack_require__(489)
  , forOf              = __webpack_require__(492)
...
__webpack_require__(508)(PROMISE);
...
var _iterator = __webpack_require__(468);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(89), __webpack_require__(100)))
...
var map = {
	"./api/Api.ts": 262,
	"./api/HttpActions.ts": 263,
	"./helpers/DomParser.ts": 250,
	"./helpers/index.ts": 458,
	"./index.ts": 251,
	"./types/app.ts": 459,
	"./types/forms.ts": 460,
	"./types/global.ts": 461,
	"./view/components/Card/index.tsx": 264,
	"./view/components/Footer/index.tsx": 166,
	"./view/components/Header/index.tsx": 167,
	"./view/components/Tabs/Tab.tsx": 265,
	"./view/components/Tabs/Tabs.tsx": 266,
	"./view/components/Tabs/index.ts": 267,
	"./view/components/index.ts": 168,
	"./view/elements/Button/index.tsx": 268,
	"./view/elements/Checkbox/index.tsx": 269,
	"./view/elements/CheckboxGroup/index.tsx": 270,
	"./view/elements/ErrorsList/index.tsx": 271,
	"./view/elements/FormControl/index.tsx": 272,
	"./view/elements/Input/index.tsx": 169,
	"./view/elements/InputsList/index.tsx": 273,
	"./view/elements/ProgressBar/index.tsx": 170,
	"./view/elements/RadioBtn/index.tsx": 171,
	"./view/elements/RadioGroup/index.tsx": 274,
	"./view/elements/index.ts": 111,
	"./view/styles/fonts/index.ts": 275
};
...
var map = {
	"./SegoeUIRegular.eot": 752,
	"./SegoeUIRegular.ttf": 753,
	"./SegoeUIRegular.woff": 754
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
